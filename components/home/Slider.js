    ...
    <div className="relative max-w-5xl px-5 mb-48 mx-auto">
        ...
        >
          {comments.map((comment, index) => (
            ...
            >
              ...
              <div className="px-9 bg-blue-2 pr-20 h-full overflow-y-auto pt-2 rounded-tr-2xl rounded-br-2xl md:pt-10">
                <Image
      ...
      <div className="flex justify-center space-x-2">
        {comments.map((comments, index) => {
          ...
          return <div className={`h-5 w-5 rounded-full ${color}`}></div>
})}
      </div>
